...
import com.shciri.rosapp.databinding.FragmentTaskExeMapViewBinding;
...
public class TaskExeMapViewFragment extends Fragment {
    ...
    private FragmentTaskExeMapViewBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentTaskExeMapViewBinding.inflate(inflater, container, false);
    ...
    private void onEvent(NavPace event) {
        binding.tvSchedule.setText(String.valueOf(event.std_msgs * 100));
    }
