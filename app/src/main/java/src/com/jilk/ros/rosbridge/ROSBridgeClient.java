...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<src.com.jilk.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<src.com.jilk.ros.rosapi.message.Service, Type>("/rosapi/service_type", src.com.jilk.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new src.com.jilk.ros.rosapi.message.Service(service)).type;
    }
