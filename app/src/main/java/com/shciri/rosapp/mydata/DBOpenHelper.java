...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql="CREATE TABLE IF NOT EXISTS map(id integer primary key autoincrement,name varchar(20),time varchar(20),width integer,height integer)";
        db.execSQL(sql);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql="CREATE TABLE IF NOT EXISTS task_history(id integer primary key autoincrement,date_created varchar(20),task_name varchar(20),task_type varchar(20),operator varchar(20), mode varchar(20), percentage integer)";
        db.execSQL(sql);
    }
}
