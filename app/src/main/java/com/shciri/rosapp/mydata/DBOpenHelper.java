...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql="ALTER TABLE info ADD COLUMN robot_ip varchar(32) NOT NULL DEFAULT 0;";
        //String sql="CREATE TABLE IF NOT EXISTS info(id integer primary key autoincrement,my_server_id int, robot_ip varchar(20))";
        db.execSQL(sql);
    }
}
