...
public class BaseDialogFragment extends DialogFragment {
    ...
    public BaseDialogFragment(BaseAttrDialog dialog) {
        mDialog = dialog;
        if (mDialog == null) {
    ...
    public static class Builder<B extends Builder> extends BaseAttrDialog.Builder<B> {
         ...
         */
        protected BaseDialogFragment createDialogFragment(BaseAttrDialog dialog) {
