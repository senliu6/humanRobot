...
public class DBUtils {
    ...
    public String getPathId(String id) {
        try {
            ...
            // 执行查询
            String[] selectionArgs = new String[]{RosData.currentMapID, id};
    ...
    public Point[] getPointS(String id, boolean pathId) {
        try {
            ...
            // 执行查询
            if (pathId) {
                selectionArgs = new String[]{RosData.currentMapID, id};
            } else {
                selectionArgs = new String[]{RosData.currentMapID, getPathId(id)};
            }
            Cursor cursor = RCApplication.db.rawQuery(query, selectionArgs);
