 ...
 * @author liudz
 */
public class BaseAttrDialog extends AppCompatDialog implements
    ...
    private final ListenersWrapper<BaseAttrDialog> mListeners = new ListenersWrapper<>(this);
    ...
    public BaseAttrDialog(Context context) {
        this(context, com.shciri.rosapp.R.style.BaseDialogStyle);
    }

    public BaseAttrDialog(Context context, int themeResId) {
    ...
    public static class Builder<B extends Builder> {
        ...
        /** Dialog 对象 */
        private BaseAttrDialog mDialog;
        /** Dialog 布局 */
         ...
         * 显示
         */
        public BaseAttrDialog show() {
            final BaseAttrDialog dialog = create();
            dialog.show();
            return dialog;
        }
         ...
         */
        protected BaseAttrDialog createDialog(Context context, @StyleRes int themeId) {
            return new BaseAttrDialog(context, themeId);
        }
         ...
         */
        protected BaseAttrDialog getDialog() {
            return mDialog;
        }
    ...
    private static final class ViewClickWrapper
        ...
        private final BaseAttrDialog mDialog;
        private final OnClickListener mListener;

        private ViewClickWrapper(BaseAttrDialog dialog, OnClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
    ...
    private static final class ShowListenerWrapper
        ...
        @Override
        public void onShow(BaseAttrDialog dialog) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null) {
    ...
    private static final class CancelListenerWrapper
        ...
        @Override
        public void onCancel(BaseAttrDialog dialog) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null) {
    ...
    private static final class DismissListenerWrapper
        ...
        @Override
        public void onDismiss(BaseAttrDialog dialog) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null) {
    ...
    private static final class KeyListenerWrapper
        ...
        public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null && dialog instanceof BaseAttrDialog) {
                mListener.onKey((BaseAttrDialog) dialog, event);
            }
            return false;
        }
    }
    ...
    public interface OnClickListener<V extends View> {
        void onClick(BaseAttrDialog dialog, V view);
    }
    ...
    public interface OnShowListener {
         ...
         * Dialog 显示了
         */
        void onShow(BaseAttrDialog dialog);
    }
    ...
    public interface OnCancelListener {
         ...
         * Dialog 取消了
         */
        void onCancel(BaseAttrDialog dialog);
    }
    ...
    public interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        void onDismiss(BaseAttrDialog dialog);
    }
    ...
    public interface OnKeyListener {
         ...
         * 触发了按键
         */
        boolean onKey(BaseAttrDialog dialog, KeyEvent event);
    }
}