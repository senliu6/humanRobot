...
public class Example {
    ...
    public static void testService(ROSBridgeClient client) {
        try {
            ...
            Service<src.com.jilk.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<src.com.jilk.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        src.com.jilk.ros.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new src.com.jilk.ros.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            src.com.jilk.ros.Topic<Log> logTopic = 
                    new src.com.jilk.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        src.com.jilk.ros.Topic<Clock> clockTopic = new src.com.jilk.ros.Topic<Clock>("/clock", Clock.class, client);
